...
const navigation = {
    ...
    school_admin: [
        ...
        { section: 'Operations' },
        { name: 'Student Attendance', path: '/school/attendance/students', icon: ClipboardList },
        { name: 'Teacher Attendance', path: '/school/attendance/teachers', icon: ClipboardList },
        { section: 'Finance' },
        { name: 'Fee Structures', path: '/school/fees/structures', icon: DollarSign },
        { name: 'Fee Records', path: '/school/fees/records', icon: DollarSign },
        { section: 'Other' },
